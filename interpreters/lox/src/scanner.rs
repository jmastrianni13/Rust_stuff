...
impl<'a> Scanner<'a> {
    ...
    fn add_token_lit(self: &mut Self, token_type: TokenType, literal: Option<LiteralValue<'a>>) {
...
impl<'a> Token<'a> {
    pub fn new(token_type: TokenType, lexeme: &'a str, literal: Option<LiteralValue<'a>>, line_number: usize) -> Self {
        Self {
            token_type,
            lexeme,
            literal,
